...
import { ChevronLeft, MapPin, Users, Check, X, Calendar, ChevronRight, Clock } from "lucide-react";
                    ...
                    <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-foreground/80 via-foreground/30 to-transparent p-6 md:p-12 pointer-events-none">
                        <div className="container mx-auto">
                            <div className="flex flex-wrap gap-2 mb-4">
                                <Badge variant="secondary" className="capitalize pointer-events-auto">
                                    {pkg.packageType}
                                </Badge>
                                {pkg.region && (
                                    <Badge variant="outline" className="text-white border-white/50 pointer-events-auto">
                                        {pkg.region}
                                    </Badge>
                                )}
                            </div>
                            ...
                            {(inclusionsList.length > 0 || exclusionsList.length > 0) && (
                                <div className="grid md:grid-cols-2 gap-6">
                                    {inclusionsList.length > 0 && (
                                        <div>
                                            <h2 className="font-serif text-2xl font-bold text-foreground mb-4">Included</h2>
                            ...
                            <div className="sticky top-24 bg-card rounded-2xl shadow-lg p-6 border border-border/50">
                                ...
                                <div className="space-y-4">
                                    <div className="p-4 bg-secondary/20 rounded-lg text-sm text-foreground/80">
                                        ...
                                        <p>Contact us to check availability and customise your stay.</p>
                                    </div>
